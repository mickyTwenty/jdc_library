...
USE(parameter1);
  ...
  if (block24.is_used()) {
    ...
    ca_.Branch(tmp30, &block22, std::vector<Node*>{}, &block23, std::vector<Node*>{});
  }
  ...
  if (block30.is_used()) {
    ...
    ca_.Branch(tmp56, &block42, std::vector<Node*>{}, &block43, std::vector<Node*>{});
  }
  ...
  if (block44.is_used()) {
    ...
    ca_.Branch(phi_bb44_19, &block39, std::vector<Node*>{}, &block40, std::vector<Node*>{});
  }
