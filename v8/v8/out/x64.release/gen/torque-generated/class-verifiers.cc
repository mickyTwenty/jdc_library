...
void TorqueGeneratedClassVerifiers::ScopeInfoVerify(ScopeInfo o, Isolate* isolate) {
  ...
  {
    Object parameter_count__value = TaggedField<Object>::load(o, 12);
    Object::VerifyPointer(isolate, parameter_count__value);
    CHECK(parameter_count__value.IsSmi());
  }
  {
    Object context_local_count__value = TaggedField<Object>::load(o, 16);
  ...
  intptr_t function_name_info__offset, function_name_info__length;
  std::tie(std::ignore, function_name_info__offset, function_name_info__length) = TqRuntimeFieldSliceScopeInfoFunctionNameInfo(o);
  CHECK_EQ(function_name_info__offset, static_cast<int>(function_name_info__offset));
  CHECK_EQ(function_name_info__length, static_cast<int>(function_name_info__length));
  for (int i = 0; i < static_cast<int>(function_name_info__length); ++i) {
    Object function_variable_name__value = TaggedField<Object>::load(o, static_cast<int>(function_name_info__offset) + 0 + i * 8);
    Object::VerifyPointer(isolate, function_variable_name__value);
    CHECK(function_variable_name__value.IsString() || function_variable_name__value.IsZero());
    Object function_variable_context_or_stack_slot_index__value = TaggedField<Object>::load(o, static_cast<int>(function_name_info__offset) + 4 + i * 8);
    Object::VerifyPointer(isolate, function_variable_context_or_stack_slot_index__value);
    CHECK(function_variable_context_or_stack_slot_index__value.IsSmi());
  }
...
void TorqueGeneratedClassVerifiers::StackFrameInfoVerify(StackFrameInfo o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(function_name__value.IsUndefined() || function_name__value.IsNull() || function_name__value.IsString());
  }
  {
    Object method_name__value = TaggedField<Object>::load(o, 36);
    Object::VerifyPointer(isolate, method_name__value);
    CHECK(method_name__value.IsUndefined() || method_name__value.IsNull() || method_name__value.IsString());
  }
  {
    Object type_name__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, type_name__value);
    CHECK(type_name__value.IsUndefined() || type_name__value.IsNull() || type_name__value.IsString());
  }
  {
    Object eval_origin__value = TaggedField<Object>::load(o, 44);
    Object::VerifyPointer(isolate, eval_origin__value);
    CHECK(eval_origin__value.IsUndefined() || eval_origin__value.IsNull() || eval_origin__value.IsString());
  }
  {
    Object wasm_module_name__value = TaggedField<Object>::load(o, 48);
    Object::VerifyPointer(isolate, wasm_module_name__value);
    CHECK(wasm_module_name__value.IsUndefined() || wasm_module_name__value.IsNull() || wasm_module_name__value.IsString());
  }
  {
    Object wasm_instance__value = TaggedField<Object>::load(o, 52);
    Object::VerifyPointer(isolate, wasm_instance__value);
    CHECK(wasm_instance__value.IsUndefined() || wasm_instance__value.IsNull() || wasm_instance__value.IsWasmInstanceObject());
  }
  {
