...
std::vector<std::unique_ptr<ObjectProperty>> TqScopeInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  std::vector<std::unique_ptr<StructProperty>> function_name_info_struct_field_list;
  function_name_info_struct_field_list.push_back(std::make_unique<StructProperty>("function_variable_name", "v8::internal::TaggedValue", "v8::internal::Object", 0, 0, 0));
  function_name_info_struct_field_list.push_back(std::make_unique<StructProperty>("function_variable_context_or_stack_slot_index", "v8::internal::TaggedValue", "v8::internal::Object", 4, 0, 0));
  auto indexed_field_slice_function_name_info = TqDebugFieldSliceScopeInfoFunctionNameInfo(accessor, address_);
  if (indexed_field_slice_function_name_info.validity == d::MemoryAccessResult::kOk) {
    result.push_back(std::make_unique<ObjectProperty>("function_name_info", "", "", address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_function_name_info.value), std::get<2>(indexed_field_slice_function_name_info.value), 8, std::move(function_name_info_struct_field_list), GetArrayKind(indexed_field_slice_function_name_info.validity)));
  }
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDateTimeFormat::GetProperties(d::MemoryAccessor accessor) const {
  ...
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("iso8601", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 10));
  result.push_back(std::make_unique<ObjectProperty>("flags", "v8::internal::TaggedValue", "v8::internal::Object", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
