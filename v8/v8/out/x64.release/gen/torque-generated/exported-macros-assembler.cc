...
TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadScopeInfoSavedClassVariableInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i){
return LoadScopeInfoSavedClassVariableInfo_0(state_, p_o, p_i);
}
void TorqueGeneratedExportedMacrosAssembler::StoreScopeInfoSavedClassVariableInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<Smi> p_v){
return StoreScopeInfoSavedClassVariableInfo_0(state_, p_o, p_i, p_v);
}
...
TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadScopeInfoReceiverInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i){
return LoadScopeInfoReceiverInfo_0(state_, p_o, p_i);
}
void TorqueGeneratedExportedMacrosAssembler::StoreScopeInfoReceiverInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<Smi> p_v){
return StoreScopeInfoReceiverInfo_0(state_, p_o, p_i, p_v);
}
TorqueStructSlice_FunctionNameInfo_MutableReference_FunctionNameInfo_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoFunctionNameInfo(TNode<ScopeInfo> p_o){
return FieldSliceScopeInfoFunctionNameInfo_0(state_, p_o);
}
...
TNode<PrimitiveHeapObject> TorqueGeneratedExportedMacrosAssembler::LoadScopeInfoInferredFunctionName(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i){
return LoadScopeInfoInferredFunctionName_0(state_, p_o, p_i);
}
void TorqueGeneratedExportedMacrosAssembler::StoreScopeInfoInferredFunctionName(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<PrimitiveHeapObject> p_v){
return StoreScopeInfoInferredFunctionName_0(state_, p_o, p_i, p_v);
}
...
TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadScopeInfoOuterScopeInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i){
return LoadScopeInfoOuterScopeInfo_0(state_, p_o, p_i);
}
void TorqueGeneratedExportedMacrosAssembler::StoreScopeInfoOuterScopeInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<HeapObject> p_v){
return StoreScopeInfoOuterScopeInfo_0(state_, p_o, p_i, p_v);
}
...
TNode<FixedArray> TorqueGeneratedExportedMacrosAssembler::LoadScopeInfoLocalsBlockList(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i){
return LoadScopeInfoLocalsBlockList_0(state_, p_o, p_i);
}
void TorqueGeneratedExportedMacrosAssembler::StoreScopeInfoLocalsBlockList(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<FixedArray> p_v){
return StoreScopeInfoLocalsBlockList_0(state_, p_o, p_i, p_v);
}
...
TNode<FixedArray> TorqueGeneratedExportedMacrosAssembler::LoadScopeInfoModuleInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i){
return LoadScopeInfoModuleInfo_0(state_, p_o, p_i);
}
void TorqueGeneratedExportedMacrosAssembler::StoreScopeInfoModuleInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<FixedArray> p_v){
return StoreScopeInfoModuleInfo_0(state_, p_o, p_i, p_v);
}
...
TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadScopeInfoModuleVariableCount(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i){
return LoadScopeInfoModuleVariableCount_0(state_, p_o, p_i);
}
