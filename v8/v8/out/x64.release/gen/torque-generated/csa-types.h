...
struct TorqueStructPositionInfo_0 {
  ...
  std::tuple<TNode<Smi>, TNode<Smi>> Flatten() const {
    return std::tuple_cat(std::make_tuple(start), std::make_tuple(end));
  }
};
struct TorqueStructFunctionNameInfo_0 {
  TNode<Object> function_variable_name;
  TNode<Smi> function_variable_context_or_stack_slot_index;

  std::tuple<TNode<Object>, TNode<Smi>> Flatten() const {
    return std::tuple_cat(std::make_tuple(function_variable_name), std::make_tuple(function_variable_context_or_stack_slot_index));
  }
};
struct TorqueStructModuleVariable_0 {
  ...
  std::tuple<TNode<String>, TNode<Smi>, TNode<Smi>> Flatten() const {
    return std::tuple_cat(std::make_tuple(name), std::make_tuple(index), std::make_tuple(properties));
  }
};
...
struct TorqueStructReference_FunctionNameInfo_0 {
  TNode<Object> object;
  TNode<IntPtrT> offset;
  TorqueStructUnsafe_0 unsafeMarker;
...
struct TorqueStructSlice_FunctionNameInfo_MutableReference_FunctionNameInfo_0 {
  TNode<Object> object;
  TNode<IntPtrT> offset;
  TNode<IntPtrT> length;
  TorqueStructUnsafe_0 unsafeMarker;
...
struct TorqueStructSliceIterator_FunctionNameInfo_MutableReference_FunctionNameInfo_0 {
  TNode<Object> object;
  TNode<IntPtrT> start;
  TNode<IntPtrT> end;
  TorqueStructUnsafe_0 unsafeMarker;
