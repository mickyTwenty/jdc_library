...
#define TORQUE_ASSIGNED_INSTANCE_TYPES(V) \
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(LAST_STRUCT_TYPE, 115) \
    V(FIRST_FIXED_ARRAY_BASE_TYPE, 116) \
      V(FIRST_FIXED_ARRAY_TYPE, 116) \
        V(FIXED_ARRAY_TYPE, 116) \
        V(FIRST_HASH_TABLE_TYPE, 117) \
          V(HASH_TABLE_TYPE, 117) \
          V(EPHEMERON_HASH_TABLE_TYPE, 118) \
          V(GLOBAL_DICTIONARY_TYPE, 119) \
          V(NAME_DICTIONARY_TYPE, 120) \
          V(NUMBER_DICTIONARY_TYPE, 121) \
          V(ORDERED_HASH_MAP_TYPE, 122) \
          V(ORDERED_HASH_SET_TYPE, 123) \
          V(ORDERED_NAME_DICTIONARY_TYPE, 124) \
          V(SIMPLE_NUMBER_DICTIONARY_TYPE, 125) \
        V(LAST_HASH_TABLE_TYPE, 125) \
        V(CLOSURE_FEEDBACK_CELL_ARRAY_TYPE, 126) \
        V(OBJECT_BOILERPLATE_DESCRIPTION_TYPE, 127) \
        V(SCRIPT_CONTEXT_TABLE_TYPE, 128) \
      V(LAST_FIXED_ARRAY_TYPE, 128) \
      V(BYTE_ARRAY_TYPE, 129) \
      V(BYTECODE_ARRAY_TYPE, 130) \
      V(FIXED_DOUBLE_ARRAY_TYPE, 131) \
      V(INTERNAL_CLASS_WITH_SMI_ELEMENTS_TYPE, 132) \
      V(SCOPE_INFO_TYPE, 133) \
    ...
    V(WASM_CAPI_FUNCTION_DATA_TYPE, 180) \
    V(WASM_STRUCT_TYPE, 181) \
    V(WEAK_ARRAY_LIST_TYPE, 182) \
    V(WEAK_CELL_TYPE, 183) \
    V(FIRST_JS_RECEIVER_TYPE, 184) \
      V(JS_PROXY_TYPE, 184) \
      V(FIRST_JS_OBJECT_TYPE, 185) \
        V(JS_OBJECT_TYPE, 1057) \
        V(FIRST_JS_CUSTOM_ELEMENTS_OBJECT_TYPE, 185) \
          V(FIRST_JS_SPECIAL_OBJECT_TYPE, 185) \
            V(JS_GLOBAL_OBJECT_TYPE, 185) \
            V(JS_GLOBAL_PROXY_TYPE, 186) \
            V(JS_MODULE_NAMESPACE_TYPE, 187) \
      ...
      V(LAST_JS_OBJECT_TYPE, 1116) \
    V(LAST_JS_RECEIVER_TYPE, 1116) \
  V(LAST_HEAP_OBJECT_TYPE, 1116) \
