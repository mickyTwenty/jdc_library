...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  TNode<Smi> LoadScopeInfoSavedClassVariableInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i);
  void StoreScopeInfoSavedClassVariableInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<Smi> p_v);
  TorqueStructSlice_Smi_MutableReference_Smi_0 FieldSliceScopeInfoReceiverInfo(TNode<ScopeInfo> p_o);
  TNode<Smi> LoadScopeInfoReceiverInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i);
  void StoreScopeInfoReceiverInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<Smi> p_v);
  TorqueStructSlice_FunctionNameInfo_MutableReference_FunctionNameInfo_0 FieldSliceScopeInfoFunctionNameInfo(TNode<ScopeInfo> p_o);
  ...
  TNode<PrimitiveHeapObject> LoadScopeInfoInferredFunctionName(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i);
  void StoreScopeInfoInferredFunctionName(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<PrimitiveHeapObject> p_v);
  ...
  TNode<HeapObject> LoadScopeInfoOuterScopeInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i);
  void StoreScopeInfoOuterScopeInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<HeapObject> p_v);
  TorqueStructSlice_HashTable_MutableReference_HashTable_0 FieldSliceScopeInfoLocalsBlockList(TNode<ScopeInfo> p_o);
  TNode<FixedArray> LoadScopeInfoLocalsBlockList(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i);
  void StoreScopeInfoLocalsBlockList(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<FixedArray> p_v);
  ...
  TNode<FixedArray> LoadScopeInfoModuleInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i);
  void StoreScopeInfoModuleInfo(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i, TNode<FixedArray> p_v);
  TorqueStructSlice_Smi_ConstReference_Smi_0 FieldSliceScopeInfoModuleVariableCount(TNode<ScopeInfo> p_o);
  TNode<Smi> LoadScopeInfoModuleVariableCount(TNode<ScopeInfo> p_o, TNode<IntPtrT> p_i);
